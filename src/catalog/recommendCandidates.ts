...
export const DOUBLE_STARS: DoubleStar[] = [
  {
    ...
    ko: '알비레오',
    en: 'Albireo',
    separationArcsec: 34.6,
    splitWith: 'telescope',
    note: '노랑·파랑 색 대비의 대표(삼각대 고정 15× 쌍안경도 가능)',
  },
  {
    objectId: 'star:HIP65378',
    ko: '미자르·알코르',
    en: 'Mizar & Alcor',
    separationArcsec: 708,
    splitWith: 'binoculars',
    note: '맨눈 시력 테스트(11.8′). 망원경으로 미자르 자체도 14″ 이중성',
  },
  {
    objectId: 'star:HIP9640',
    ko: '알마크',
    en: 'Almach',
    separationArcsec: 9.6,
    splitWith: 'telescope',
    note: '주황·청록 대비, 가을',
  },
  {
    objectId: 'star:HIP63125',
    ko: '코르 카롤리',
    en: 'Cor Caroli',
    separationArcsec: 19.3,
    splitWith: 'telescope',
    note: '봄 하늘의 가장 쉬운 이중성',
  },
  {
    objectId: 'star:HIP91919',
    ko: '거문고자리 엡실론',
    en: 'Epsilon Lyrae',
    separationArcsec: 208,
    splitWith: 'binoculars',
    note: '"더블 더블" — 쌍안경으로 둘, 망원경 100× 이상으로 넷',
  },
  {
    objectId: 'star:HIP36850',
    ko: '카스토르',
    en: 'Castor',
    separationArcsec: 5.6,
    splitWith: 'telescope',
    note: '90mm에서 잘 갈라짐, 겨울',
  },
  {
    objectId: 'star:HIP11767',
    ko: '북극성',
    en: 'Polaris',
    separationArcsec: 18.2,
    splitWith: 'telescope',
    note: '9등급 동반성이 어둡게 보임',
  },
  {
    objectId: 'star:HIP24436',
    ko: '리겔',
    en: 'Rigel',
    separationArcsec: 9.4,
    splitWith: 'telescope',
    note: '주성이 밝아 시상이 좋아야 함(도전)',
  },
  {
    objectId: 'star:HIP80763',
    ko: '안타레스',
    en: 'Antares',
    separationArcsec: 2.6,
    splitWith: 'telescope',
    challenge: true,
    note: '한국에서 고도가 낮아 90mm로는 드물게만 분해',
  },
  {
    objectId: 'star:HIP84345',
    ko: '라스알게티',
    en: 'Rasalgethi',
    separationArcsec: 4.6,
    splitWith: 'telescope',
    note: '주황·초록빛 대비, 여름',
  },
  {
    objectId: 'star:HIP50583',
    ko: '알기에바',
    en: 'Algieba',
    separationArcsec: 4.7,
    splitWith: 'telescope',
    note: '황금빛 한 쌍, 봄',
  },
  {
    objectId: 'star:HIP102532',
    ko: '돌고래자리 감마',
    en: 'Gamma Delphini',
    separationArcsec: 9,
    splitWith: 'telescope',
  ...
  {
    objectId: 'star:HIP3821',
    ko: '카시오페이아자리 에타',
    en: 'Achird (η Cas)',
    separationArcsec: 13.4,
    splitWith: 'telescope',
    note: '노랑·붉은 동반성, 가을',
  },
];
...
/** 추천 후보 별자리 = 유명 별자리 + 유성우 복사점 별자리(용자리·물병자리; 검색 제안에는 넣지 않는다) */
export const RECOMMEND_CONSTELLATIONS: ObjectId[] = [
...
export function buildCandidates(cat: Catalog): Candidate[] {
  ...
  for (const d of cat.dso) {
    ...
    push({
      ...
      con: d.con,
      tags:
        d.messier !== undefined ? ['messier'] : d.caldwell !== undefined ? ['caldwell'] : undefined,
    });
  }
  for (const id of RECOMMEND_CONSTELLATIONS) {
