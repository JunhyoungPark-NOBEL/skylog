...
선행 연습의 별도 숫자(예: 장반경 3배, 구슬의 1/2과 1/4)는 본 문제 정답을 대신 대입한 것이 아니다. 본 문제의 결과를 미리 완성하지 않고 비례와 조건을 배운다. 선행 문제 답과 본 문제 성취는 저장 계층에서도 구별해야 한다. 이 파일에는 저장·결제·완료 판정 코드가 없다.
