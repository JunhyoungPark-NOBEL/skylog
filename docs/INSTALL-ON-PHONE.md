...
3. **배경**에서 언덕·돌산·설산·바다를, **지면**에서 잔디·모래·돌·눈을 고릅니다. 잠긴 풍경도 그림을 눌러 미리 볼 수 있고 조건을 달성하면 적용할 수 있습니다. **표시**에서 장식을 작게/조금 크게 보거나 잠시 숨길 수 있습니다. 숨겨도 배치는 남습니다.
...
배우기 → 퀴즈 → 천체물리는 이야기10개가 각각9단계로 이어집니다. 관측 질문부터 계산까지 차근차근 진행하며 점선 밑줄 용어를 **길게 누르면** 뜻이 나옵니다. 짧은 터치는 설명을 열지 않습니다. 이야기에는 사진이나 선이 또렷한 천체 도해를 표시하고, 업적은48개를5분류·3열로 모아 전체와 분류별 달성 수를 보여줍니다. 일반 이메일 로그인의 실사용 개통은 SMTP 준비 후 확인해야 합니다.
