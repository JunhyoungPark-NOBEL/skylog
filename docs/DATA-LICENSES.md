...
| 파일                     | 내용                                                                  | 출처/근거                                    | 검토 상태                                    |
| ------------------------ | --------------------------------------------------------------------- | -------------------------------------------- | -------------------------------------------- |
| `star-names-ko.csv`      | 별 120개 한글 이름·전통 이름(직녀성·견우성·북극성·천랑성·노인성·삼태) | IAU WGSN 공식 이름 + 통용 한글 표기          | 전부 `needs_review=true` → GPT Pro G2로 검증 |
| `constellations-ko.csv`  | 별자리 88개 한글 이름·소유격·계절                                     | 한국천문학회 천문학용어집                    | 살쾡이·조각가·조각칼·작은여우자리 표기 검토  |
| `dso-names-ko.csv`       | DSO 100개 한글 이름·별칭(좀생이별·묘성·프레세페…)                     | 통용 명칭, 위키백과 ko                       | 전부 검토 대상                               |
| `caldwell.csv`           | 콜드웰 109개 ↔ NGC/IC                                                 | Caldwell catalogue (Moore 1995), 위키백과 en | 전부 검토 대상                               |
