...
- 브라우저 전체 34개 통과. 기존 하늘 테스트 2개의 초기 마운트 대기 경쟁 조건 수정. 단위 366개(363+네이티브 세션3) 통과. 방향·코스 스크린샷 확인. iOS arm64 무서명 컴파일 성공(run 34173355892), 웹 배포 성공(run 34173356290). Android 첫 컴파일의 JSON float 예외 계약을 Collection 생성자로 수정하고 AAB/lint/오프라인 계측을 재검증한다.
